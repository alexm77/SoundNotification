...
public class SettingsActivity extends PreferenceActivity {
	 ...
	 * #ALWAYS_SIMPLE_PREFS}, or the device doesn't have newer APIs like {@link PreferenceFragment}, or the device
	 * doesn't have an extra-large screen. In these cases, a single-pane "simplified" settings UI should be shown.
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d(getClass().getName(), "Activity starting service");
